...
export const statDashboardCards: StatCardProps[] = [
    { label: 'Pending Review', count: 156, color: 'warning', icon: 'i-lucide-inbox', trendValue: '2%', trendDescription: 'Active institutional partnerships' },
    { label: 'Under Review', count: 89, color: 'secondary', icon: 'i-lucide-file-search', trendValue: '-2%', trendDescription: 'Active institutional partnerships' },
    { label: 'Approved', count: 34, color: 'success', icon: 'i-lucide-thumbs-up', trendValue: '2%', trendDescription: 'Active institutional partnerships' },
    { label: 'Need Revision', count: 7, color: 'error', icon: 'i-lucide-circle-alert', trendValue: '-2%', trendDescription: 'Active institutional partnerships' }
]
