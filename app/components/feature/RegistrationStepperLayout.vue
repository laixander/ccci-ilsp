...
<template>
    <div class="space-y-6">
        <!-- Step Indicator -->
        <div class="space-y-2">
            <div class="flex justify-between items-center text-sm font-medium text-dimmed">
            ...
            <div class="flex justify-between text-xs font-medium text-muted mt-1">
        ...
        <!-- Step Content -->
        <div class="border border-gray-200 dark:border-gray-800 p-6 rounded-xl bg-white dark:bg-gray-900">
